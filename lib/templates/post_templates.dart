...
// make a function to build the posts of residential
   ...
   static post_residential(var context, String main_img,
       ...
       bool property_state,String title_deed,
       )
   {
               ...
               children: [
                 ...
                 Positioned(
                   ...
                   child: Container(
                       ...
                       decoration: BoxDecoration(
                           color: secondary_color3.withOpacity(0.7),
                 ...
                 children: [
                   Padding(padding: EdgeInsets.fromLTRB(4.w, 1.h, 4.w, 0),
                     ...
                     Row(
                       ...
                       children: [
                         Text("المساحة:$area م² ", style: TextStyle(fontSize: 19, fontWeight: FontWeight.w500, color: Diary_font_color),),
                         Text("$residential_type-$sell_rent", style: TextStyle(fontSize: 19, fontWeight: FontWeight.w500, color: Diary_font_color),)
                       ],
                     ),
                   ),
                   ...
                   Padding(padding: EdgeInsets.fromLTRB(4.w, 0, 4.w, 1.h),
                     ...
                     Row(
                       mainAxisAlignment: MainAxisAlignment.spaceBetween,
                       children: [
                         Text("السعر: $price $price_type", style: TextStyle(fontSize: 19, fontWeight: FontWeight.w500, color: Diary_font_color),),
                         Text("$city-$district", style: TextStyle(fontSize: 19, fontWeight: FontWeight.w500, color: Diary_font_color),),
                       ],
                     ),
                   ),
                         ...
                         Container(
                           ...
                           child: Row(
                             ...
                             children: [
                               ...
                               Text("$bathroom",style: TextStyle(fontSize: 16.5.sp, color: Diary_font_color),),
  ...
  static post_land(var context, String main_img,
      ...
      String area, String area_type, String interface, String depth,
      String price, String price_type,
      String owner, String owner_phone, String property_describtion,
      bool property_state,String title_deed,
      )
